...
# Variables globales
FRECUENCIA_CORTE = 20  # Frecuencia de corte para el filtro pasa bajos
...
def graficar_senales_tiempo(senal_sana, senal_interictal, senal_convulsion, fs=173.61):
...
def graficar_comparacion_tiempo(senal_original, senal_filtrada, titulo, fs=173.61):
    ...
    plt.plot(tiempo, senal_original, alpha=0.5, label='Original', linewidth=1)
    plt.plot(tiempo, senal_filtrada, label='Filtrada', linewidth=1.2, color='red')
